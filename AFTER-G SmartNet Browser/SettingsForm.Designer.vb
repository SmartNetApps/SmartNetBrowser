...
Partial Class SettingsForm
    ...
    Private Sub InitializeComponent()
        ...
        '
        resources.ApplyResources(Me.SetDefaultDownloadFolderButton, "SetDefaultDownloadFolderButton")
        Me.SetDefaultDownloadFolderButton.Name = "SetDefaultDownloadFolderButton"
        Me.SetDefaultDownloadFolderButton.UseVisualStyleBackColor = True
        '
        'DefaultDownloadFolderTextBox
        '
        resources.ApplyResources(Me.DefaultDownloadFolderTextBox, "DefaultDownloadFolderTextBox")
        Me.DefaultDownloadFolderTextBox.Name = "DefaultDownloadFolderTextBox"
        '
        ...
        '
        resources.ApplyResources(Me.RadioButtonBlockAllCookies, "RadioButtonBlockAllCookies")
        Me.RadioButtonBlockAllCookies.Name = "RadioButtonBlockAllCookies"
        Me.RadioButtonBlockAllCookies.TabStop = True
        Me.RadioButtonBlockAllCookies.UseVisualStyleBackColor = True
        '
        'RadioButtonBlockThirdPartyCookies
        '
        resources.ApplyResources(Me.RadioButtonBlockThirdPartyCookies, "RadioButtonBlockThirdPartyCookies")
        Me.RadioButtonBlockThirdPartyCookies.Name = "RadioButtonBlockThirdPartyCookies"
        Me.RadioButtonBlockThirdPartyCookies.TabStop = True
        Me.RadioButtonBlockThirdPartyCookies.UseVisualStyleBackColor = True
        '
        'RadioButtonAcceptAllCookies
        '
        resources.ApplyResources(Me.RadioButtonAcceptAllCookies, "RadioButtonAcceptAllCookies")
        Me.RadioButtonAcceptAllCookies.Name = "RadioButtonAcceptAllCookies"
        Me.RadioButtonAcceptAllCookies.TabStop = True
        Me.RadioButtonAcceptAllCookies.UseVisualStyleBackColor = True
        '
        'TrackingGroupBox
        '
    ...
    Friend WithEvents HistoryFavoritesSecurityCheckBox As CheckBox
    ...
    Friend WithEvents GroupBoxCookies As GroupBox
